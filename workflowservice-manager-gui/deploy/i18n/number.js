 ...
 */
define('i18n/number/base/numeral',[],function () {
...
define('i18n/number',['i18n!i18n/number/languages','i18n/number/base/numeral'],function (lang, numeral) {
    'use strict';

    numeral.language('current', lang);
    numeral.language('current');
    var slice = Array.prototype.slice;

    /**
     * The Number extension provide Internationalized different Numbering formats.
     * <br/>
     * <strong>Detailed information on <a href="../../tutorial_number.html">Documentation page</a></strong>
     *
     * @class i18n.number
     */
    function number(input) {
         ...
         * @return {String}
         * @example
         *  var numberValue = 100000000;
         *  number(numberValue ).format('0,0.0000');
         */

        return numeral.apply(this, arguments);

    }

    var methods = ['languageData', 'format'];

    methods.forEach(function (method) {
        number[method] = function () {
            var args = slice.call(arguments);
            return numeral[method].apply(numeral, args);
        };
    });
