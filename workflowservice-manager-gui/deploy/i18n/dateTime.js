...
define('i18n/datetime/base/moment',[],function () {
    'use strict';
    //! moment.js
//! version : 2.6.0
...
define('i18n/dateTime',['i18n!i18n/datetime/languages','i18n/datetime/base/moment'],function (lang, moment) {
    'use strict';

    moment.lang('current', lang);

    var slice = Array.prototype.slice;
    /**
     * The dateTime extension provide Internationalized date and time formats.
     * <br/>
     * <strong>Detailed information on <a href="../../tutorial_datetime.html">Documentation page</a></strong>
     *
     * @class i18n.dateTime
     */
    function dateTime(input, format, lang, strict) {
        /**
         * Method to format Internationalized date and Time.
         *
         * <strong>Formating Options:</strong>
         *  <ul>
         *    <li><strong>LT</strong>	17:54 </li>
         *    <li><strong>L</strong>   15/02/2014 </li>
         *    <li><strong>l</strong>   15/2/2014 </li>
         *    <li><strong>LL</strong>	February 15 2014 </li>
         *    <li><strong>ll</strong>	Feb 15 2014 </li>
         *    <li><strong>LLL</strong>	February 15 2014 5:54 PM </li>
         *    <li><strong>lll</strong>	Feb 15 2014 5:54 PM </li>
         *    <li><strong>LLLL</strong>	Saturday, February 15 2014 5:54 PM </li>
         *    <li><strong>llll</strong>	Sat, Feb 15 2014 5:54 PM </li>
         *  </ul>
         *
         * @method format
         * @static
    ...
    var methods = ['fromNow', 'langData', 'format'];

    methods.forEach(function (method) {
        dateTime[method] = function () {
            var args = slice.call(arguments);
            return moment[method].apply(moment, args);
        };
    });
