...
gsh create_diameter_application -da s6a -ls true -dh w5p2vmme7 -rn ericsson.se

gsh create_diameter_peer -ip 10.42.83.241 -pn 1 -portno 3868 -sip NULL -prio NULL -dh w5p2vmme7 -rn ericsson.se

gsh create_diameter_peer -ip 172.22.49.1 -pn 2 -portno 3868 -sip NULL -prio NULL -dh w5p2vmme7 -rn ericsson.se
...
gsh create_ip_interface -ifn ETH_1_1_0_0_VPN1 -ip 10.70.245.3 -mask 255.255.255.248 -rip NULL -eqp 1.1 -ep 1 -vid 0 -ifp ETH_1_1_0_0_VPN1 -nw VPN1

gsh create_ip_interface -ifn ETH_1_2_0_0_VPN1 -ip 10.70.245.4 -mask 255.255.255.248 -rip NULL -eqp 1.2 -ep 1 -vid 0 -ifp ETH_1_2_0_0_VPN1 -nw VPN1

gsh create_ip_network -nw VPN1

gsh create_ip_service -sn DNS -dscp NULL -nw VPN1

gsh create_ip_service_address -sn DNS -ip 10.70.245.33

gsh create_ip_service -sn NTP -dscp NULL -nw VPN1

gsh create_ip_service_address -sn NTP -ip 10.70.245.33

gsh create_ip_service -sn OAM -dscp NULL -nw VPN1

gsh create_ip_service_address -sn OAM -ip 10.70.245.33

gsh create_ip_service -sn S1-MME-1 -dscp NULL -nw VPN1

gsh create_ip_service_address -sn S1-MME-1 -ip 10.70.245.9

gsh create_ip_service -sn S1-MME-2 -dscp NULL -nw VPN1

gsh create_ip_service_address -sn S1-MME-2 -ip 10.70.245.10

gsh create_ip_service -sn S10-GTP-C -dscp NULL -nw VPN1

gsh create_ip_service_address -sn S10-GTP-C -ip 10.70.245.25

gsh create_ip_service -sn S11-GTP-C -dscp NULL -nw VPN1

gsh create_ip_service_address -sn S11-GTP-C -ip 10.70.245.25

gsh create_ip_service -sn S3-GTP-C -dscp NULL -nw VPN1

gsh create_ip_service_address -sn S3-GTP-C -ip 10.70.245.25

gsh create_ip_service -sn S6a-1 -dscp NULL -nw VPN1

gsh create_ip_service_address -sn S6a-1 -ip 10.70.245.17

gsh create_ip_service -sn S6a-2 -dscp NULL -nw VPN1

gsh create_ip_service_address -sn S6a-2 -ip 10.70.245.18

gsh create_local_diameter_host -dh w5p2vmme7 -rn ericsson.se -no 2
...
gsh modify_ne -cnid NULL -isdn 00 -ni w5p2vmme7 -nl 4 -rbnri 6 -mgi 32769 -mc 7 -rmc 64 -daf 0 -tlo currentTai -ssm allUe -ivh false -dan NULL -hcmv 2 -cpsm false -dpmm false -qna false -aifav true -gtdm false -lrc 14 -hhfdut 60
...
gsh create_static_route -eqp 0.0 -nw VPN1 -dip 0.0.0.0 -mask 0.0.0.0 -gip 10.70.245.2
